...
- **[VIDEO-STREAM-019](docs/experiments/video-stream-019.md): DELIVERED, NO PLAYBACK** — The receiver fetched complete MPEG-2 and MP4 clips from the bedroom PC, but this Vivo Play/browser route stayed on “Please wait.” Native playback remains untested.
- **[MEDIA-CONTROL-020](docs/experiments/media-control-020.md): PROBED, NO MEDIA LOAD** — The receiver exposed Ekioh media-control objects, but SVG video did not request its source or advance its clock. A native playback contract is still needed.
