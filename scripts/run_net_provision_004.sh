#!/usr/bin/env bash
# NET-PROVISION-004: HTTP Interceptor and Relay Session Runner (Multi-IP)
set -euo pipefail
...
PCAP_FILE="${CAPTURES_DIR}/net-provision-004.pcap"
HTTP_LOG="${CAPTURES_DIR}/net-provision-004.log"
INTERCEPTOR_STDOUT="${CAPTURES_DIR}/http_interceptor.log"
ARP_LOG="${CAPTURES_DIR}/arp_spoofer.log"
...
echo "[+] NET-PROVISION-004 is ACTIVE. Bounded duration: ${DURATION} seconds."
